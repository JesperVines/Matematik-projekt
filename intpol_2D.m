% Denna funktion interpolerar över ett område på en bild.

% Ett korrekt anrop med en bild "testbild.png" samt en funktion
% "mask_rect" som skapar en maskmatris:
% intpol_2D('testbild.png',mask_rect('testbild.png')) öppnar
% först ett fönster där "testbild.png" visas och användaren
% får klicka hörnpunkter som tillsammans bildar 
% rektanglar.
